...
@section('content')
    ...
    <section class="container">
        <div class="container px-5">
            <form method="post" action="{{url('advertisement/update/'.$advertisement['a_id'])}}"
                  enctype="multipart/form-data">
                @csrf
                <div class="row d-flex justify-content-end">
                    <input name="adID" type="text" class="form-control col-4 mr-3" id="adID"
                           placeholder="ID" value="{{$advertisement['a_id']}}" readonly disabled @required(true)>
                    <input name="date" type="text" class="form-control col-4" id="date"
                           placeholder="Date" onfocus="(this.type='date')" value="{{$advertisement['date']}}" @required(true)>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mb-3">
                    <div class="col p-0">
                        <select value="{{$advertisement['category']}}" class="form-control"
                                aria-label="Default select example" name="category" @required(true)>
                    ...
                    <div class="col p-0">
                        <input type="text" class="form-control" id=" title" name="title"
                               placeholder="Title" value="{{$advertisement['title']}}" @required(true)>
                    </div>
                </div>
                <div class="row pb-3">
                    <div class="col p-0">
