...
<div class="container" style="margin-left: 100px; margin-right: 20px">
        <div class="row">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{url('update-exam')}}">
                    @csrf
                    <input type="hidden" name="id" value="{{$Data->id}}">
                    <div class="md-3">
                        <label class="form-lable">Exam Name : </label>
                        <input type="text" class="form-control" name="ex_name" value="{{$Data->ex_name}}">
                        @error('Exam Name')
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="attempt" value="{{$Data->attempt}}">
                        @error('Attempt')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        {{-- <input type="text" class="form-control" name="add_question" value="{{$Data->add_question}}">
                        @error('Add Question')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    {{-- <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="show_question" value="{{$Data->show_question}}">
                        @error('show Question')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
