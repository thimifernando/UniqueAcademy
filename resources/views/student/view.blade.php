        ...
        <form action="{{ route('student.status') }}" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        <label for="email" class="req_fld">Birthday</label>
                        <input class="form-control" type="text" disabled value="{{$emp->student->birthday}}" autocomplete="off">
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="phone" class="req_fld">Grade</label>
                        <input class="form-control" type="text" disabled value="{{$emp->student->grade}}">
                    </div>
                    <div class="col-md-4 form-group">
